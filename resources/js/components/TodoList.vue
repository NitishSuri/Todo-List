        ...
        <div class="row justify-content-center">
            <div class="col-sm-6">
                <div id="todo-container" class="p-3">
                    <section id="todo-header" class="mt-10">
                        <h3 class="text-center">Welcome Team The Code Work!</h3>
                    </section>
                    <section id="todo-errors">
                        <div v-if="createTodoForm.errors.length > 0" class="alert alert-warning alert-dismissible fade show" role="alert">
                            ...
                            <el-button type="button" class="close" data-dismiss="alert" aria-label="Close">
                        ...
                        <form>
                            <div class="d-flex justify-content-between align-items-center">
                                <input
                                    ...
                                    <el-button v-if="createTodoForm.isSubmitting" class="btn btn-primary" type="primary"  disabled>
                                ...
                                <el-button v-else @click.prevent="addTodo" class="btn btn-primary">Add</el-button>
                            </div>
                        </form>
                    </section>
                    ...
                    <section id="todo-list">
                        <ul class="list-group">
                            ...
                            <div  v-for="todo in todos.data" :key="todo.uuid">
                                <li
